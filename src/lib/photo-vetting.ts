...
// Хвост после токена: конец строки, разделитель ИЛИ цифры («chanote2.jpg»,
// «scan001.jpg» — нумерованная пачка сканов). Цифра границей слова не является,
// поэтому без этой ветки защита снималась одним нажатием клавиши.
