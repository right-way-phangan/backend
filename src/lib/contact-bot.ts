...
const SYSTEM_PROMPT =
  ...
  "leasehold, company, nominee, 49/51), taxes, or payment/escrow mechanics — say " +
 ...
 * safe by construction: the prompt forbids quoting prices/legal/escrow and asks
 * the model to append `#handoff` when a human should step in. Any failure → null,
