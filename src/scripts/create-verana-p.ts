...
const DESC_EN =
  ...
  "One- and three-bedroom formats are available on request. Photographs show completed villas of the same design at the resort. Right Way arranges the viewing. The developer handles the sale and your own lawyer checks the documents.";
...
const DESC_RU =
  ...
  "Форматы с одной и тремя спальнями — по запросу. На фотографиях — построенные виллы того же дизайна в резорте. Показ объекта организует Right Way. Сделку ведёт застройщик, документы проверяет ваш юрист.";
